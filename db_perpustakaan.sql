...
CREATE DATABASE IF NOT EXISTS `db_perpustakaan` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci */;
USE `db_perpustakaan`;

-- Dumping structure for table db_perpustakaan.absens
...
-- Dumping data for table db_perpustakaan.absens: ~2 rows (approximately)
...
-- Dumping data for table db_perpustakaan.migrations: ~4 rows (approximately)
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(21, '2024_10_15_154903_create_absens_table', 2);
...
-- Dumping data for table db_perpustakaan.sessions: ~3 rows (approximately)
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('VgDp2PZ3SNCLSbCWQtjLJD1dVFsUjVFLOH0kSTd7', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoicWJnRHlnYUY0NW5iZWhnV3ZLSUJnYTlBWjRJcmM5TE83czNOSk80cSI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6Mjk6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMC9hYnNlbnNpIjt9czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319fQ==', 1729060458);
